                ...
                <div>
                  ...
                  <div className="relative z-10 mb-10 overflow-hidden rounded-md bg-primary bg-opacity-10 p-8 md:p-9 lg:p-8 xl:p-9">
                    <p className="text-center text-base font-medium italic text-body-color">
                      "Next.js has transformed how we think about React
                      development. It's not just a framework; it's a complete
                      solution for building production-ready web applications
                  ...
                  <p className="mb-10 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                    Implementing Next.js in your projects can significantly
                    improve both developer productivity and application
                    performance. The framework's opinionated structure helps
                    maintain consistency across projects, while its flexibility
                    allows for customization when needed.
                  </p>
